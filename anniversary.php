...
<body>
    <?php
       ...
       $conn = new mysqli($servername, $dbusername, $dbpassword, $dbname);
        ...
        // Fetch stock values
        $sql = "SELECT sstock, mstock, lstock FROM anniversary WHERE itemid = 3";
    ...
    <form action="cartadder.php" method="post">
        ...
        <div class="product">
            ...
            <div class="item-details">
                ...
                <p>A limited edition shirt from the Anniversary of the Krooked Clothing. Designed through perfection, made to commemorate journey and celebrate the future of style.</p>
                <br>
                <p>🔘Features<br>
                &emsp; ○ Cotton<br>
                &emsp; ○ Asian Size<br>
                &emsp; ○ Premium Quality<br>
                &emsp; ○ Soft, Stretchable, and Comfortable<br>
                &emsp; ○ Designed for a relaxed and cozy look</p>
                <br>
                <p>🔘Size/Fit<br>
                ...
                &emsp; ◙ Washing<br>
                &emsp; &emsp; : Gentle cycle<br>
                &emsp; &emsp;: Wash dark colors separately<br>
                &emsp; &emsp;: Wash inside out with cold water<br>
                &emsp; ◙ Drying<br>
                &emsp; &emsp;: Hang-dry<br>
                &emsp; &emsp;: Tumble dry low<br>
                ⚠️DO NOT ⚠️<br>
                &emsp;&emsp;: Do not dry clean<br>
                &emsp;&emsp;: Avoid using bleach esp. on dark fabrics</p>
            </div>
        </div>
        <hr>
