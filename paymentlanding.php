...
if (isset($_SESSION['latestorderdetails'])) {
    $lastorderID = $_SESSION['lastorderdetails'];
    header("Location: orderspage.php?orderid=$lastorderID");
    exit();
} else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        // Insert payment details with the retrieved user ID
