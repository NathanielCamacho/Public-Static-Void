...
<?php
       ...
       $conn = new mysqli($servername, $dbusername, $dbpassword, $dbname);
        ...
        // Fetch stock values
        $sql = "SELECT sstock, mstock, lstock FROM lebron WHERE itemid = 2";
...
<form action="cartadder.php" method="post">
        ...
        <input type="hidden" name="product_name" value="LeBron"> 
    ...
    <div class="product">
        <div class="content">
        <img src="krooked product/lebron.png" alt="lebron">
        <div class="product_container">
            <div class="description">LEBRON</div> 
