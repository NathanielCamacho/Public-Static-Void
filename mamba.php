...
<?php
       ...
       $conn = new mysqli($servername, $dbusername, $dbpassword, $dbname);
        ...
        // Fetch stock values
        $sql = "SELECT sstock, mstock, lstock FROM mamba WHERE itemid = 1";
...
<form action="cartadder.php" method="post">
    ...
    <div class="item-details">
        ...
        <p>Inspired by  Kobe Bryant, The Mamba shirt redefined greatness, enthusiasm, and hardwork. Made with 100% Cotton, Designed for perfect outfit ideas.
</p>
        <br>
        <p>
        🔘Features
